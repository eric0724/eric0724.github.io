...
Remove-Item (Join-Path $tmp 'app\platform') -Recurse -Force -ErrorAction SilentlyContinue
Remove-Item (Join-Path $tmp 'app\scripts') -Recurse -Force -ErrorAction SilentlyContinue
